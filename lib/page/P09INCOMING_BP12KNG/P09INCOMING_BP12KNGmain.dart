...
import 'P09INCOMING_BP12KNG_CONSOLEbox/P09INCOMING_BP12KNG_CONSOLEbox.dart';
import 'P09INCOMINGvar_BP12KNG.dart';

//------------------------------------

late BuildContext P09INCOMING_BP12KNGmaincontext;
String _searchResult = '';

class P09INCOMING_BP12KNGmain extends StatelessWidget {
  /// {@macro counter_page}
  P09INCOMING_BP12KNGmain({Key? key, this.data}) : super(key: key);
  List<dataset>? data;
  @override
...
class _TableBodyState extends State<TableBody> {
  ...
  void initState() {
    ...
    P09INCOMINGvar_BP12KNG_INCOMINGDATAoutput.UserNO = USERDATA.ID;
    context.read<P09INCOMING_BP12KNGget>().add(GetDataPressed());
  }

  @override
  Widget build(BuildContext context) {
    P09INCOMING_BP12KNGmaincontext = context;
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
        ...
        onSelectChanged: (value) {
          ...
          P09INCOMINGvar_BP12KNG.ItemName = '';
          P09INCOMINGvar_BP12KNG.statusNow = '';
          P09INCOMINGvar_BP12KNG.specialAccStatusNow = '';
          P09INCOMINGvar_BP12KNG.specialAccCOMMENTNow = '';
          P09INCOMINGvar_BP12KNG.specialAccPicNow = '';
          P09INCOMINGvar_BP12KNG.confirmPass = '';
          P09INCOMINGvar_BP12KNG.wait = '';
          P09INCOMINGvar_BP12KNG.PassText = '';
          P09INCOMINGvar_BP12KNG.ListITEM = [];

          P09INCOMINGvar_BP12KNG_NOGOODcon.NoGoodPage = 1;
          P09INCOMINGvar_BP12KNG_NOGOODcon.PiecesDropdownSelected = '1';
          P09INCOMINGvar_BP12KNG_NOGOODcon.yesno = 0;
          P09INCOMINGvar_BP12KNG_NOGOODcon.undercontrol = false;
          P09INCOMINGvar_BP12KNG_NOGOODcon.SpacialAccText = '';
          P09INCOMINGvar_BP12KNG_NOGOODcon.attper = 0;
          P09INCOMINGvar_BP12KNG_NOGOODcon.base64pic01 = imgw;
          P09INCOMINGvar_BP12KNG_NOGOODcon.base64pic02 = imgw;
          P09INCOMINGvar_BP12KNG_NOGOODcon.base64pic03 = imgw;
          P09INCOMINGvar_BP12KNG_NOGOODcon.base64pic04 = imgw;
          P09INCOMINGvar_BP12KNG_NOGOODcon.base64pic05 = imgw;
          ...
          P09INCOMING_BP12KNG_ConsoleBoxBODY(data, context);
          notifyListeners();
        },
        cells: [
          DataCell(Text(
