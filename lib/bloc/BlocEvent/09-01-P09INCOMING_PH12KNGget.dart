...
class CounterValue extends P09INCOMING_BP12KNGget {
  final int value;
  CounterValue(this.value);
}

class P09INCOMING_BP12KNGget extends Bloc<DataSetEvent, List<dataset>> {
  /// {@macro counter_bloc}
  P09INCOMING_BP12KNGget() : super(<dataset>[]) {
