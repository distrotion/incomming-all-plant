...
import 'P10INCOMING_BP12PVD_CONSOLEbox/P10INCOMING_BP12PVD_CONSOLEbox.dart';
import 'P10INCOMINGvar_BP12PVD.dart';

//------------------------------------

late BuildContext P10INCOMING_BP12PVDmaincontext;
String _searchResult = '';

class P10INCOMING_BP12PVDmain extends StatelessWidget {
  /// {@macro counter_page}
  P10INCOMING_BP12PVDmain({Key? key, this.data}) : super(key: key);
  List<dataset>? data;
  @override
...
class _TableBodyState extends State<TableBody> {
  ...
  void initState() {
    ...
    P10INCOMINGvar_BP12PVD_INCOMINGDATAoutput.UserNO = USERDATA.ID;
    context.read<P10INCOMING_BP12PVDget>().add(GetDataPressed());
  }

  @override
  Widget build(BuildContext context) {
    P10INCOMING_BP12PVDmaincontext = context;
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
        ...
        onSelectChanged: (value) {
          ...
          P10INCOMINGvar_BP12PVD.ItemName = '';
          P10INCOMINGvar_BP12PVD.statusNow = '';
          P10INCOMINGvar_BP12PVD.specialAccStatusNow = '';
          P10INCOMINGvar_BP12PVD.specialAccCOMMENTNow = '';
          P10INCOMINGvar_BP12PVD.specialAccPicNow = '';
          P10INCOMINGvar_BP12PVD.confirmPass = '';
          P10INCOMINGvar_BP12PVD.wait = '';
          P10INCOMINGvar_BP12PVD.PassText = '';
          P10INCOMINGvar_BP12PVD.ListITEM = [];

          P10INCOMINGvar_BP12PVD_NOGOODcon.NoGoodPage = 1;
          P10INCOMINGvar_BP12PVD_NOGOODcon.PiecesDropdownSelected = '1';
          P10INCOMINGvar_BP12PVD_NOGOODcon.yesno = 0;
          P10INCOMINGvar_BP12PVD_NOGOODcon.undercontrol = false;
          P10INCOMINGvar_BP12PVD_NOGOODcon.SpacialAccText = '';
          P10INCOMINGvar_BP12PVD_NOGOODcon.attper = 0;
          P10INCOMINGvar_BP12PVD_NOGOODcon.base64pic01 = imgw;
          P10INCOMINGvar_BP12PVD_NOGOODcon.base64pic02 = imgw;
          P10INCOMINGvar_BP12PVD_NOGOODcon.base64pic03 = imgw;
          P10INCOMINGvar_BP12PVD_NOGOODcon.base64pic04 = imgw;
          P10INCOMINGvar_BP12PVD_NOGOODcon.base64pic05 = imgw;
          ...
          P10INCOMING_BP12PVD_ConsoleBoxBODY(data, context);
          notifyListeners();
        },
        cells: [
          DataCell(Text(
