...
abstract class P05INCOMING_HESGASgetstatusEvent {}

/// Notifies bloc to increment state.
class GetDataPressedST extends P05INCOMING_HESGASgetstatusEvent {
  GetDataPressedST({required this.ITEMcode});

  String ITEMcode;
}

class FlushITDataPressed extends P05INCOMING_HESGASgetstatusEvent {}

class CounterValue extends P05INCOMING_HESGASgetstatus {
  final int value;
  CounterValue(this.value);
}

class P05INCOMING_HESGASgetstatus
    extends Bloc<P05INCOMING_HESGASgetstatusEvent, statusinc> {
  /// {@macro counter_bloc}
  P05INCOMING_HESGASgetstatus() : super(statusinc()) {
