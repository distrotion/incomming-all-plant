...
import '../page1.dart';
import 'P11INCOMING_BP12PAL_CONSOLEbox/P11INCOMING_BP12PAL_CONSOLEbox.dart';
import 'P11INCOMINGvar_BP12PAL.dart';

//------------------------------------

late BuildContext P11INCOMING_BP12PALmaincontext;
String _searchResult = '';

class P11INCOMING_BP12PALmain extends StatelessWidget {
  /// {@macro counter_page}
  P11INCOMING_BP12PALmain({Key? key, this.data}) : super(key: key);
  List<dataset>? data;
  @override
...
class _TableBodyState extends State<TableBody> {
  ...
  void initState() {
    ...
    P11INCOMINGvar_BP12PAL_INCOMINGDATAoutput.UserNO = USERDATA.ID;
    context.read<P11INCOMING_BP12PALget>().add(GetDataPressed());
  }

  @override
  Widget build(BuildContext context) {
    P11INCOMING_BP12PALmaincontext = context;
  ...
  DataRow getRow(int index) {
    ...
    return DataRow.byIndex(
        ...
        onSelectChanged: (value) {
          ...
          P11INCOMINGvar_BP12PAL.ItemName = '';
          P11INCOMINGvar_BP12PAL.statusNow = '';
          P11INCOMINGvar_BP12PAL.specialAccStatusNow = '';
          P11INCOMINGvar_BP12PAL.specialAccCOMMENTNow = '';
          P11INCOMINGvar_BP12PAL.specialAccPicNow = '';
          P11INCOMINGvar_BP12PAL.confirmPass = '';
          P11INCOMINGvar_BP12PAL.wait = '';
          P11INCOMINGvar_BP12PAL.PassText = '';
          P11INCOMINGvar_BP12PAL.ListITEM = [];

          P11INCOMINGvar_BP12PAL_NOGOODcon.NoGoodPage = 1;
          P11INCOMINGvar_BP12PAL_NOGOODcon.PiecesDropdownSelected = '1';
          P11INCOMINGvar_BP12PAL_NOGOODcon.yesno = 0;
          P11INCOMINGvar_BP12PAL_NOGOODcon.undercontrol = false;
          P11INCOMINGvar_BP12PAL_NOGOODcon.SpacialAccText = '';
          P11INCOMINGvar_BP12PAL_NOGOODcon.attper = 0;
          P11INCOMINGvar_BP12PAL_NOGOODcon.base64pic01 = imgw;
          P11INCOMINGvar_BP12PAL_NOGOODcon.base64pic02 = imgw;
          P11INCOMINGvar_BP12PAL_NOGOODcon.base64pic03 = imgw;
          P11INCOMINGvar_BP12PAL_NOGOODcon.base64pic04 = imgw;
          P11INCOMINGvar_BP12PAL_NOGOODcon.base64pic05 = imgw;
          ...
          P11INCOMING_BP12PAL_ConsoleBoxBODY(data, context);
          notifyListeners();
        },
        cells: [
          DataCell(Text(
